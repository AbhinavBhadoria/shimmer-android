...
public class ShimmerConstraintLayout extends ConstraintLayout {
  ...
  public ShimmerConstraintLayout(Context context, AttributeSet attrs) {
    super(context, attrs);
    init(context, attrs);
  }

  public ShimmerConstraintLayout(Context context, AttributeSet attrs, int defStyleAttr) {
  ...
  public ShimmerConstraintLayout setShimmer(Shimmer shimmer) {
    if (shimmer == null) {
